...
namespace DiscordChatGPTBot.Interaction.Utility
{
    [Group("utility", "工具")]
...
#endif     
            await Context.Interaction.SendConfirmAsync("<https://discordapp.com/api/oauth2/authorize?client_id=" + _client.CurrentUser.Id + "&permissions=274878188608&scope=bot%20applications.commands>", ephemeral: true);
        }
